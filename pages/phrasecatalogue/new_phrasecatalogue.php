                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                ...
                                <li>
                                    <a href="new_phrasecatalogue.php">
                                    ...
                                    <ul class= "list-unstyled navbar__sub-list js-sub-list">
                                        ...
                                        <li>
                                            <a href="propertytree_import.html">
                                                <i class="fas fa-tree"></i>Propertytree Import
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <li class="has-sub">
                                    ...
                                    <ul class = "list-unstyled navbar__sub-list js-sub-list">
                                        ...
                                        <li>
                                            <a href="phraseset_export.html">
                                                <i class="fas fa-file-export"></i>Phraseset Export
                                            </a>
                                        </li>
                                        <li>
                                            <a href="propertytree_export.html">
                                                <i class="fas fa-tree"></i>Propertytree Export
                                            </a>
                                        </li>
                                        <li>
                                            <a href="../help/help-import-export.html">
                                ...
                                <li class="has-sub">
                                    ...
                                    <ul class= "list-unstyled navbar__sub-list js-sub-list">
                                       <li>
                                        ...
                                        <li>
                                            <a href="new_phrasehead_phrasehead_ref.html">
                                                <i class="fas fa-file"></i>New Phrasehead-Phrasehead-Reference
                                            </a>
                                        </li>
                                        <li>
                                            <a href="list_phrasehead_phrasehead_ref.html">
                                 ...
                                 <li class="has-sub">
                                    ...
                                    <ul class= "list-unstyled navbar__sub-list js-sub-list">
                                       <li>
                                        ...
                                        <li>
                                            <a href="special_data_mapping.html">
...
<!--                        <li class=" has-sub">
                        ...
                        <li class=" has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="../admin/admin_landing.html">
            ...
            -->
                        ...
                        <li class=" has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="../admin/admin_landing.html">
                                        <i class="fas fa-calendar-alt"></i>Translations per month and user</a>
                                </li>
                                <li>
                                    <a href="../admin/admin_not_translated.html">
                                        <i class="fas fa-exclamation"></i>Missing Translations of Languagetexts</a>
                                ...
                                <li>
                                    <a href="../admin/admin_country_not_translated.html">
                                        <i class="fas fa-flag"></i>Missing Translations of Countrynames</a>
                                </li>
                                <li>
                                    <a href="../admin/admin_company_list.html">
                                        <i class="fas fa-list"></i>List of Companies</a>
                                ...
                                <li>
                                    <a href="../admin/admin_new_company.html">
                                        <i class="fas fa-plus-square"></i>New Company</a>
                                </li>
                                <li>
                                    <a href="../admin/admin_credit_point.html">
                                        <i class="fas fa-coins"></i>List Creditpoints</a>
                         ...
                         <li class=" has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="../help/help-user.html">
                                        <i class="fas fa-file-alt"></i>User Data and Registration</a>
                                </li>
                                <li>
                                    <a href="../help/help_phrasetexts_translations.html">
                                        <i class="fas fa-globe-europe"></i>Phrasetexts and Translations</a>
